    ...
    <section id="tools" className="space-y-6">
      <div className="max-w-2xl">
        ...
        <p className="mt-3 text-sm leading-relaxed text-white/50 sm:text-base">
          Modular creation surfaces with cinematic craft, built for teams who
          ship beautiful work.
        </p>
      </div>
          ...
          return (
            ...
            >
              <GlassPanel
                ...
                framed
                className={cn(
                  "group h-full cursor-pointer p-4 transition duration-500 hover:-translate-y-1",
                  tool.glow
                )}
              >
                <div
                ...
                <div className="relative flex items-start justify-between gap-3">
                  <div className="grid size-12 place-items-center rounded-2xl border border-white/10 bg-white/[0.05] text-white shadow-[inset_0_1px_0_oklch(1_0_0/0.08)] transition duration-300 group-hover:scale-105 group-hover:border-white/20">
